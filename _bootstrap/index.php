...
if (!createObject('modNamespace',array(
    'name' => 'commerce_formulashipping',
    'path' => $componentPath.'/core/components/commerce_formulashipping/',
    'assets_path' => $componentPath.'/assets/components/commerce_formulashipping/',
),'name', false)) {
    echo "Error creating namespace commerce_formulashipping.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_formulashipping.core_path',
    'value' => $componentPath.'/core/components/commerce_formulashipping/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_formulashipping',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_formulashipping.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_formulashipping.assets_path',
    'value' => $componentPath.'/assets/components/commerce_formulashipping/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_formulashipping',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_formulashipping.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_formulashipping/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_formulashipping.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_formulashipping',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_formulashipping.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        'key' => 'commerce_formulashipping.' . $key,
        'value' => $opts['value'],
        'xtype' => $xtype,
        'namespace' => 'commerce_formulashipping',
        'area' => $opts['area'],
        ...
        echo "Error creating commerce_formulashipping.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_formulashipping/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_formulashipping/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'PoconoSewVac\\FormulaShipping\\Modules\\', $modulePath);
